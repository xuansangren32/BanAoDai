...
namespace BanAoDai.Areas.Admin.Controllers
{
    public class ConfigController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Site_name,Hot_Line,Email,Status")] Config config)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Site_name,Hot_Line,Email,Status")] Config config)
        {
            if (ModelState.IsValid)
            {
