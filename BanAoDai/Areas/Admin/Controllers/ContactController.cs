...
namespace BanAoDai.Areas.Admin.Controllers
{
    public class ContactController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Email,Wedsite,Message,IsRead")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Email,Wedsite,Message,IsRead")] Contact contact)
        {
            if (ModelState.IsValid)
            {
